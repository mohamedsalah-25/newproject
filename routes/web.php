...
Route::get('add_product/{req}', [App\Http\Controllers\AdminController::class, 'show']);
...
Route::get('/search', [App\Http\Controllers\AdminController::class, 'search'])->name('products.search');
...
Route::post('myorder/{phone}',[App\Http\Controllers\HomeController::class, 'remove_username'])->name('user.remove');
